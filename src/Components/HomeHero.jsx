    ...
    <div ref={ref} className="relative h-[100vh] sm:h-[110vh] overflow-hidden text-white">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full px-6 md:px-16 max-w-7xl mx-auto text-center md:text-left">
        ...
        <motion.button
          ...
          className="mb-4 text-[#FFF165] border-2 border-[#FFF165] font-bold px-4 py-2 rounded-full text-sm w-fit mx-auto md:mx-0"
        >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={inView ? 'visible' : 'hidden'}
          className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-6"
        >
        ...
        >
          <button className="bg-gradient-to-br from-white to-[#FFF165] hover:from-[#FFF165] hover:to-white text-black font-semibold px-6 py-3 rounded-full transition">
            Our Services
          </button>
